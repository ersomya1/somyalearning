...

{
		...
		public   void startup() 
		{
			report = new ExtentReports("C:\\Users\\DELL\\eclipse-workspace\\com.mavente\\reports\\LoginPageReport.html",true);
	...
	//	  Assert.assertEquals("WELCOME",homePageTitle);
	 ...
	 logger.log(LogStatus.INFO, logger.addScreenCapture(Helper.CaptureScreenshot(driver, "val2")));
